#!/usr/bin/env python3
"""
Demo script for the OCEAN pipeline.
...
Usage:
  python apps/demos/demo_ocean_pipeline.py --count 3 --provider dashscope --api-key <key>
"""
...
async def main():
    parser = argparse.ArgumentParser(
        description="Generate personas with OCEAN personality"
    )
    parser.add_argument(
        "--count", "-n",
        type=int,
    ...
    print("=" * 70)
    print("OCEAN PIPELINE WITH TWO-PASS NARRATIVES")
    print("=" * 70)
    print(f"\nConfiguration:")
    ...
    try:
        ocean_personas = await generate_ocean_personas(
    ...
    print(f"  python apps/demos/demo_ocean_pipeline.py --count 5 --provider dashscope --api-key <key>")
    print()
