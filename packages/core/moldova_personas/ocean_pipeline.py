"""
OCEAN pipeline with two-pass narrative generation.
...
class OCEANPersona:
    """
    Complete persona with OCEAN personality.
...
class OCEANPipeline:
    """
    OCEAN pipeline with score-and-rewrite loop.
    ...
    def __init__(
        ...
        rewrite_config: Optional[GenerationConfig] = None,
    ):
        ...
        self.rewrite_config = rewrite_config or GenerationConfig(
            max_tokens=1500,
    ...
    async def generate(
        ...
        """
        Generate complete persona with OCEAN.
        ...
        Returns:
            OCEANPersona with validated OCEAN consistency
        """
        # === PASS 1: STRUCTURE ===
...
async def generate_ocean_personas(
    ...
    """
    Generate personas with OCEAN personality.
    ...
    Returns:
        List of OCEANPersona with validated OCEAN
    """
    if provider == "mock":
    ...
    async def generate_one(persona: Persona, name: str) -> OCEANPersona:
